                            ...
                            <div className="snap-x mx-auto snap-mandatory h-screen flex w-screen overflow-scroll">
                                ...
                                <div className="bg-gradient-to-r from-slate-900 to-black h-screen w-screen snap-start flex-shrink-0">
                                    ...
                                    <div className="flex items-center justify-center pt-20">
                                        <div className="p-8">
                                            <a
                                                href="https://docs.google.com/document/d/1gCBBjTNtp-1y6pgiAZXzNUuuphlio33a4ynD4KjzjI4/edit"
                                                className="block mt-1 text-3xl pb-16 leading-tight font-extralight semibold text-red-400 hover:underline"
                                            >
                                                Full Cold Flow
                                            </a>
                                            <a
                                                href="https://docs.google.com/document/d/14GF5MH0N8Yn4MlxrpHHRUVzbeaHv8t03B6nIXnOz9cA/edit"
                                                className="block mt-1 text-3xl pb-16 leading-tight font-extralight semibold text-red-400 hover:underline"
                                            >
                                                Ethanol Cold Flow
                                            </a>
                                            <a
                                                href="https://docs.google.com/document/d/1iI569RTfhWI-AH_hSjzrGw4IRnJhikwxDennu7UTNIM/edit"
                                                className="block mt-1 text-3xl pb-16 leading-tight font-extralight semibold text-red-400 hover:underline"
                                            >
                                                Nitrous Oxide Cold Flow
                                            </a>
                                            <a
                                                href="https://docs.google.com/document/d/1AZ03p1kXIEovYirM9cFSvwT6QkPfyxXxAKxO2AltLW8/edit"
                                                className="block mt-1 text-3xl leading-tight font-extralight semibold text-red-400 hover:underline"
                                            >
                                                Nitrous Water Cold Flow
                                            </a>
