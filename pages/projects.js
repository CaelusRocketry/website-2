                    ...
                    <div className="snap-x mx-auto snap-mandatory h-screen flex w-screen overflow-scroll">
                        <div className="bg-gradient-to-r from-slate-900 to-black h-screen w-screen snap-start flex-shrink-0 flex flex-row">
                            <div>
                                ...
                                <div className="p-6">
                                    <a
                                        href="https://www.youtube.com/watch?v=QW5VUM-bRI4"
                                        className="underline decoration-indigo-500 underline-offset-8 decoration-4 pt-12 flex items-center justify-center mt-1 text-4xl leading-tight font-extralight semibold text-indigo-500 hover:underline"
                                    >
                                        Video
                                    </a>
                                    <p className="mt-2 text-xl font-medium text-indigo-500"></p>
                                </div>
                            </div>

                            <div className="pt-6 pr-6 pl-12">
                                <Image src={cat1} alt=""></Image>
                                <Image src={cat3} alt=""></Image>
                            </div>
                        </div>
                        ...
                        <div className="bg-gradient-to-r from-slate-900 to-black h-screen w-screen snap-start flex-shrink-0 flex flex-row">
                            <div className="pr-24">
                                ...
                                <div className="pt-6 pl-6 tracking-wide text-base text-white font-extralight semibold">
