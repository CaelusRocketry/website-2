                            ...
                            <div className="flex flex-row">
                                <div className=" pt-48 p-6 w-1/2">
                                    <a
                                        ...
                                        className="underline decoration-indigo-500 underline-offset-8 decoration-4 pt-12 flex items-center justify-center mt-1 text-8xl leading-tight font-extralight semibold text-indigo-500 hover:underline"
                                    >
                                        NASA
                                    </a>
