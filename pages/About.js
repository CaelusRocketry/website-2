...
export default function about() {
    return (
      ...
      <main className="bg-black h-max">
        ...
        <div className="flex flex-items-center justify-center pt-12 pb-12 underline decoration-indigo-500 underline-offset-8 decoration-4 uppercase tracking-wide text-4xl text-white font-extralight semibold">Core Values</div>
        <div className="bg-gradient-to-r from-slate-900 to-black rounded-3xl">
  <div className="md:flex">
  
  <div className = "pl-0 pr-0">

  <div className="bg-slate-900 rounded-3xl shadow-2xl">
    <div className="p-8">
      <a href="#" className="block mt-1 text-2xl leading-tight font-extralight semibold text-white hover:underline">Teamwork</a>
  ...
  <div className = "pr-20 pl-20 pt-12">
  ...
  <div className="bg-slate-900 flex items-center justify-center rounded-3xl shadow-2xl">
    <div className="p-8">
      <a href="#" className="block mt-1 text-2xl leading-tight font-extralight semibold text-white hover:underline">Responsibility</a>
      <p className="mt-2 text-white">
  ...
  <div className = "pr-20 pl-20 pt-12 pb-24">
  <div className="grid justify-items-end bg-gradient-to-r from-slate-900 to-black rounded-3xl">
  <div className="grid justify-items-end md:flex">
  
  <div className = "pl-0 pr-0">

  <div className="bg-slate-900 flex justify-items-end rounded-3xl shadow-2xl">
    <div className="p-8">
      <a href="#" className="block mt-1 text-2xl leading-tight font-extralight semibold text-white hover:underline">Enjoyment</a>
      <p className="mt-2 text-white">
